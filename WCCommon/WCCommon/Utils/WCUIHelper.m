...
@implementation WCUIHelper (QMUIMoreOperationAppearance)
...
@implementation WCUIHelper (QMUIAlertControllerAppearance)
...
@implementation WCUIHelper (QMUIDialogViewControllerAppearance)
...
+ (void)customDialogViewControllerAppearance {
    ...
    appearance.backgroundColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<QDThemeProtocol> * _Nullable theme) {
        if ([identifier isEqualToString:WCThemeIdentifierDark]) {
...
@implementation WCUIHelper (QMUIEmotionView)
...
@implementation WCUIHelper (QMUIImagePicker)
...
@implementation WCUIHelper (QMUIPopupContainerView)
...
+ (void)customPopupAppearance {
    ...
    popup.maskViewBackgroundColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, __kindof NSObject<QDThemeProtocol> * _Nullable theme) {
        return [identifier isEqual:WCThemeIdentifierDark] ? UIColorMask : UIColorMaskWhite;
    }];
...
@implementation WCUIHelper (UITabBarItem)
...
@implementation WCUIHelper (Button)
...
@implementation WCUIHelper (Emotion)
...
@implementation WCUIHelper (SavePhoto)
...
@implementation WCUIHelper (Calculate)
...
@implementation WCUIHelper (Theme)
